...
class TestDataset(unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual('number', self.dataset.schema.get_field_type('field_number'))
        self.assertEqual('string', self.dataset.schema.get_field_type('field_string'))
        self.assertEqual('boolean', self.dataset.schema.get_field_type('field_boolean'))
    ...
    def test_to_dict(self):
        ...
        self.assertEqual('number', dataset_dict['schema']['field_number'])
        self.assertEqual('string', dataset_dict['schema']['field_string'])
        self.assertEqual('boolean', dataset_dict['schema']['field_boolean'])
    ...
    def test_from_api_response(self):
        api_response = {
            'name': 'test_dataset',
            'description': 'test_description',
            'schema': [{'name': 'field_number', 'type': 'number'},
